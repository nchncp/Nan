...
if(mysqli_num_rows($rsSelect) > 0){
	...
	$TmpNoteImgNameNew = "tmp" . $txtUsername . ".png";
	...
	update($txtRoomNo, $OldNoteImg, $txtUsername, $NoteImgNameOLD, $imgTime);

}else{
	$NoteImgNameNew = $txtUsername . "_RoomName" . $txtRoomNo . ".png";
	...
	."(ANNOTATIONID, ANNOTATION_TEXT, ROOM_NO, ANNOTATION_OWNER, SOURCE_IMAGE, ANNOTATION_UPD_TIMESTAMP) "
	."VALUES (NULL, '$NoteImgNameNew', '$txtRoomNo', '$txtUsername','images_SN/$NoteImgNameNew', '$NowTimeStampLT' )";
...
$connect = $con -> getConnection();
	...
	$SrcImage = "images_SN/" . $NoteImgNameOLD . "?time=" . $imgTime;
